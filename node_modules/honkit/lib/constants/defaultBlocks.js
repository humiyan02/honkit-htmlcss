...
exports.default = immutable_1.default.Map({
    html: templateBlock_1.default({
        name: "html",
        process: function (blk) {
            return blk;
        },
    }),
    code: templateBlock_1.default({
        name: "code",
        process: function (blk) {
            return {
                html: false,
    ...
    markdown: templateBlock_1.default({
        name: "markdown",
        process: function (blk) {
    ...
    asciidoc: templateBlock_1.default({
        name: "asciidoc",
        process: function (blk) {
    ...
    markup: templateBlock_1.default({
        name: "markup",
        process: function (blk) {
